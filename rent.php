            ...
            <div class="col-lg-8 col-md-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-5 col-sm-5">
                            <div class="sorting-options">
                                <a href="properties-list-leftsidebar.php" class="change-view-btn active-view-btn"><i class="fa fa-th-list"></i></a>
                ...
                <div class="property-box-2" >
                    <div class="row">
                        <div class="col-lg-5 col-md-5 col-pad">
                            <div class="property-thumbnail">
                                <a href="ppropertydetail.php" class="property-img">
                ...
                <div class="pagination-box hidden-mb-45 text-center">
                    <nav aria-label="Page navigation example">
                        <ul class="pagination">
                            ...
                            <li class="page-item"><a class="page-link active" href="rent.php">2</a></li>
                            <li class="page-item"><a class="page-link" href="buy.php">3</a></li>
                            <li class="page-item">
                                <a class="page-link" href="buy.php">Next</a>
                            </li>
                        </ul>
                    </nav>
                </div>
