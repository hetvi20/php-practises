                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-7 col-md-7 col-pad">
                            <div class="detail">
                                ...
                                <div class="footer">
                                    <a href="#" tabindex="0">
                                        <i class="flaticon-people"></i> vedent nayi
                                    </a>
                                    <span>
                        ...
                        <div class="col-lg-5 col-md-5 col-pad">
                            <div class="property-thumbnail">
                                <a href="propertydetail.php" class="property-img">
                                    ...
                                    <div class="price-box"><span>50 lakh</span></div>
                                </a>
                            </div>
                        </div>
                        <div class="col-lg-7 col-md-7 col-pad">
                                ...
                                <div class="hdg">
                                    ...
                                    <h5 class="location">
                                        <a href="propertydetail.php">
                                            <i class="flaticon-pin"></i>20-21 Kathal patan City, FL
                                        </a>
                                    </h5>
                                </div>
                                <ul class="facilities-list clearfix">
                        ...
                        <div class="col-lg-5 col-md-5 col-pad">
                            <div class="property-thumbnail">
                                <a href="propertydetail.php" class="property-img">
                                    ...
                                    <div class="price-box"><span>75 lakh</span></div>
                                </a>
                            </div>
                        </div>
                        <div class="col-lg-7 col-md-7 col-pad">
                            <div class="detail">
                                <div class="hdg">
                                    ...
                                    <h5 class="location">
                                        <a href="propertydetail.php">
                                            <i class="flaticon-pin"></i>20-21 Kathal St. Ahmadabad City, FL
                                        </a>
                                    </h5>
                                </div>
                                <ul class="facilities-list clearfix">
                        ...
                        <div class="col-lg-7 col-md-7 col-pad">
                            <div class="detail">
                                <div class="hdg">
                                    ...
                                    <h5 class="location">
                                        <a href="propertydetail.php">
                                            <i class="flaticon-pin"></i>20-21 Kathal St. pune City, FL
                                        </a>
                                    </h5>
                                </div>
                                <ul class="facilities-list clearfix">
                                ...
                                <div class="footer">
                                    <a href="#" tabindex="0">
                                        <i class="flaticon-people"></i> Mahi Doe
                                    </a>
                                    <span>
                                          <i class="flaticon-calendar"></i>5 Days ago
                                    </span>
                        ...
                        <div class="col-lg-7 col-md-7 col-pad">
                            <div class="detail">
                                <div class="hdg">
                                    ...
                                    <h5 class="location">
                                        <a href="propertydetail.php">
                                            <i class="flaticon-pin"></i>20-21 Kathal St. bombay City, FL
                                        </a>
                                    </h5>
                                </div>
                                <ul class="facilities-list clearfix">
                                ...
                                <div class="footer">
                                    <a href="#" tabindex="0">
                                        <i class="flaticon-people"></i> Jhoni singaniya
                                    </a>
                                    <span>
                                          <i class="flaticon-calendar"></i>5 Days ago
                                    </span>
                        ...
                        <div class="col-lg-5 col-md-5 col-pad">
                            <div class="property-thumbnail">
                                <a href="propertydetail.php" class="property-img">
                                    ...
                                    <div class="price-box"><span>89 lakh</span></div>
                                </a>
                            </div>
                        </div>
                        <div class="col-lg-7 col-md-7 col-pad">
                            <div class="detail">
                                <div class="hdg">
                                    ...
                                    <h5 class="location">
                                        <a href="propertydetail.php">
                                            <i class="flaticon-pin"></i>20-21 Kathal St. pillipain City, FL
                                        </a>
                                    </h5>
                                </div>
                                <ul class="facilities-list clearfix">
                                ...
                                <div class="footer">
                                    <a href="#" tabindex="0">
                                        <i class="flaticon-people"></i> Dhur brambhat
                                    </a>
                                    <span>
                                          <i class="flaticon-calendar"></i>5 Days ago
                                    </span>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-7 col-md-7 col-pad">
                            <div class="detail">
                                <div class="hdg">
                                    <h3 class="title">
                                        <a href="propertydetail.php"> Old Home</a>
                                    </h3>
                                    <h5 class="location">
                                        <a href="propertydetail.php">
                                            <i class="flaticon-pin"></i>20-21 Kathal St. Rampur City, FL
                                        </a>
                                    </h5>
                                </div>
                                <ul class="facilities-list clearfix">
                                ...
                                <div class="footer">
                                    <a href="#" tabindex="0">
                                        <i class="flaticon-people"></i> vikas kalal
                                    </a>
                                    <span>
                                          <i class="flaticon-calendar"></i>5 Days ago
                                    </span>
                ...
                <div class="pagination-box hidden-mb-45 text-center">
                    <nav aria-label="Page navigation example">
                        <ul class="pagination">
                            ...
                            <li class="page-item"><a class="page-link active" href="sale.php">1</a></li>
                            <li class="page-item"><a class="page-link" href="rent.php">2</a></li>
                            <li class="page-item"><a class="page-link" href="buy.php">3</a></li>
                            <li class="page-item">
...
<a href="compareproperty.php"><button class="button button1">COMPARE PROPERTY</button>    </div>
</div></a>
