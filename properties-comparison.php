...
<div class="sub-banner overview-bgi">
    <div class="container">
        <div class="breadcrumb-area">
            <h1>Properties Comparison</h1>
            <ul class="breadcrumbs">
                <li><a href="index.php">Home</a></li>
                <li class="active">Properties Comparison</li>
            </ul>
        </div>
    </div>
</div>
            ...
            <form method="GET">
                <div class="row sidebar search-compare">
                    <div class="col-md-12 col-lg-12">
                        <h4>Select Propertie's You Want To Compare</h4>
                    </div>
                    <div class="col-lg-4 col-md-4 col-lg-3">
                ...
                <div class="property-box">
                    <div class="property-thumbnail">
                        <a href="properties-details.html" class="property-img">
                            ...
                            <div class="price-box">$850/Month</div>
...
<!-- Comparison start -->
<div class="comparison faq content-area-2">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div id="faq" class="faq-accordion">
                    <div class="card">
                        ...
                        <div id="collapse1" class="card-block collapse mb-10">
                        ...
                        <div id="collapse2" class="card-block collapse mb-10">
                            <div class="compare-table">
                                <table>
                                    <tbody>
                                    <tr>
                        ...
                        <div id="collapse3" class="card-block collapse mb-10">
                            <div class="compare-table">
                                <table>
                                    <tbody>
                                    <tr>
